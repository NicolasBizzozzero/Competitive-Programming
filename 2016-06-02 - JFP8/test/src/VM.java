...
public class VM {
    ...
    public VM(ArrayList<String> code, Tortue tortue) {
        this.code = code;
        this.tortue = tortue;
    ...
    public boolean interpreterInstruction() {
        if (pointeurInstruction >= code.size()) {
            throw new WrongInstructionException("null instruction");
        }
        String instruction = code.get(pointeurInstruction);
        //dépiler
        if(instruction == null) {
            throw new WrongInstructionException("null instruction");
        }
        ...
        //Instructions avec mnemonic de 4 ou 5 caractères.
            ...
            if(mnemonic.equals("call ")) {
                ...
                if(argument <0 || argument >=code.size()) {
